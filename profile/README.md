...
| **[formulary-mcp-server](https://github.com/openpharma-org/formulary-mcp-server)** | ACA marketplace formulary data (4,800+ plans, 13K drugs) | CMS QHP Formulary Files |
